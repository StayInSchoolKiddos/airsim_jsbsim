...
import airsim_jsbsim.jsbsim_backend.properties as prp
from airsim_jsbsim.jsbsim_backend.aircraft import Aircraft, cessna172P, x8
#from jsbsim_backend.aircraft import Aircraft, cessna172P, x8
from airsim_jsbsim.conversions import feet_to_meters, meters_to_feet, knots_to_mps, mps_to_knots
...
class FlightDynamics:
    ...
    def __init__(self,
                 ...
                 ip_address:str=None,
                 airsim_frequency_hz:float=48.0):
        ...
        if self.use_airsim:
            self.client = self.airsim_connect(self.ip_address)
        else:
            print("Airsim not connected")
